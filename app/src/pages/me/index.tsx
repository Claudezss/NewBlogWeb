...
interface MeProps extends RouteChildrenProps {
...
class Me extends Component<MeProps, MeState> {
  ...
  renderChildrenByTabKey = (tabKey: MeState['tabKey']) => {
    if (tabKey === 'projects') {
      return <Projects />;
    }
...
export default connect(
  ({ loading, me }: { loading: { effects: { [key: string]: boolean } }; me: ModalState }) => ({
    currentUser: me.currentUser,
    currentUserLoading: loading.effects['me/fetchCurrent'],
  }),
)(Me);
